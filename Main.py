...
#Logrando explicabilidad en Sistemas de Recomendación mediante técnicas de Factorización Matricial y aprendizaje sobre el contenido de los usuarios. 
if "stats" in stage:
    model.get_data_stats()

if "grid" in stage:
    params = {"learning_rate": lrates, "epochs":epochs}
